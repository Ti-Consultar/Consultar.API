...
namespace _2___Application._1_Services.ValueTree
{
    public class ValueTreeService : BaseService
    {
        ...
        public async Task<ValueTreeResultDto> GetAll(int accountPlanId, int month, int year)
        {
            ...
            var custosVariaveis = monthDRE?.Totalizer.SelectMany(t => t.Classifications)
            ...
            var custos = custoMercadorias + custoServicosPrestados + custosVariaveis + despesasVariaveis;
     ...
     .Where(m => m.DateMonth <= month); // << filtro aqui
        ...
        public async Task<ValueTreeResultDto> GettAllOrcado(int accountPlanId, int month, int year)
        {
            ...
            var painelOperationalEfficiency = await GetOperationalEfficiencyOrcado(accountPlanId, year);
     ...
     .Where(m => m.DateMonth <= month); // << filtro aqui
        ...
        public async Task<ValueTreeComparativoResponse> BuildValueTreeComparativo(int accountPlanId, int month, int year)
        {
            ...
            realizado ??= new ValueTreeResultDto
            {
                ...
                EconomicView = new EconomicViewDto(),
                FinancialView = new FinancialViewDto(),
        ...
        public async Task<PainelOperationalEfficiencyResponseDto> GetOperationalEfficiencyOrcado(int accountPlanId, int year)
        {
            var painelAtivo = await BuildPainelBalancoReclassificadoByTypeAtivoOrcado(accountPlanId, year, 1);
            var painelPassivo = await BuildPainelBalancoReclassificadoByTypePassivoOrcado(accountPlanId, year, 2);
            var painelDRE = await BuildPainelByTypeDREOrcado(accountPlanId, year, 3);
