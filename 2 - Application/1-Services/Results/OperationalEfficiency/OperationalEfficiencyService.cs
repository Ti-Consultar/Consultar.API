...
namespace _2___Application._1_Services.Results.OperationalEfficiency
{
    public class OperationalEfficiencyService : BaseService
    {
        ...
        public async Task<PainelOperationalEfficiencyResponseDto> GetOperationalEfficiency(
            int accountPlanId,
            int year,
            int? groupId = null,
            int? companyId = null,
        ...
        public async Task<PainelOperationalEfficiencyComparativoResponseDto> GetOperationalEfficiencyComparativo(
            int accountPlanId,
            int year,
            int? groupId = null,
            int? companyId = null,
