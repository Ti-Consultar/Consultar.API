...
namespace _4_InfraData._1_Repositories
{
    public class BalanceteRepository : GenericRepository<BalanceteModel>
    {
        ...
        public async Task<List<BalanceteModel>> GetByFinancialScopeMonth(
            int accountPlansId,
            int groupId,
            int? companyId,
            int? subCompanyId,
        ...
        public async Task<List<BalanceteModel>> GetByFinancialScopeDate(
            int accountPlanId,
            int groupId,
            int? companyId,
            int? subCompanyId,
        ...
        public async Task<List<BalanceteModel>> GetAccountPlanWithBalancetesMonthAsync(
            int accountPlanId,
            int? groupId,
            int? companyId,
            int? subCompanyId)
        {
            var query = _context.Balancete
                .Include(x => x.AccountPlans)
                .Where(ap => ap.AccountPlansId == accountPlanId);
